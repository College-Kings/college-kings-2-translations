...
translate chinese v2s39_53acd157:
    ...
    bartender "很高兴今晚能见到你们，欢迎来到芒果酒吧贵宾区！"
...
translate chinese v2s39_3e813e9a:
    ...
    bartender "今晚我们为你们准备了全套酒水，从啤酒到普罗塞克，以及龙舌兰，甚至鸡尾酒，都包含在贵宾派对套餐里。"
...
translate chinese v2s39_d7a46ee6:
    ...
    bartender "我被告知你们还未成年，所以尽管我们不能给你们提供我们正常的酒水名单。"
...
translate chinese v2s39_eb02c470:
    ...
    u "(今晚似乎进展顺利，但林赛没有提到任何关于想获得他们支持的事情……)"
...
translate chinese v2s39_574a29ef:
    ...
    u "(即使我们刚刚得到狼人对克洛伊竞选的支持，他仍然在这里支持他的朋友。)"
...
translate chinese v2s39_a493bc4f:
    ...
    u "(尽管克洛伊刚刚宣布狼人正式成为她的兄弟，他仍然在这里为他的朋友。)"
...
translate chinese v2s39_462e713c:
    ...
    u "(至少我认为我们得到了他们的支持，那张照片是一个低级的打击……)"
...
translate chinese v2s39_56478e4d:
    ...
    li "你说得对，是为了支持我。这就是我带你们来这里和我共度良宵的最终原因。"
...
translate chinese v2s39_9a929e0d:
    ...
    se "我不能评论，我不太了解她。我们不怎么说话，所以严格来说，没有。"
...
translate chinese v2s39_b287d10d:
    ...
    se "我的意思是，再说一次，不是很多。我想我可能对克洛伊没什么好说的，但至少有几件关于你强调的好事要说。"
...
translate chinese v2s39_d98e95e4:
    ...
    u "(这将是一个尝试记录林赛说一些关于克洛伊坏话的好时机。希望我能抓到些有用的东西。)"
...
translate chinese v2s39_51f3c949:
    ...
    aut "我曾邀请她参加一些鹿会的活动，但她总是放我鸽子。通常连道歉的都没有。"
...
translate chinese v2s39_2d25d16f:
    ...
    li "我不是说她是个坏人。我只是觉得她不能胜任她本该做的工作。"
...
translate chinese v2s39_d998e4f7:
    ...
    li "小鸡会的会长应该支持你所有的活动，秋。你难道不希望这样吗？"
...
translate chinese v2s39_4e43e683:
    ...
    li "对我来说，支持其他女生会将对每个人都有好处，这就是为什么我们都在这里，对吗？"
...
translate chinese v2s39_963b4ef9:
    ...
    li "我们可以保持良好的竞争关系，但我们需要互相支持。克洛伊似乎不明白。"
...
translate chinese v2s39_stop_lindsey_12177cfa:
    ...
    li "*醉醺醺* 噢，噢，是的，我很抱歉。那听起来一定很贱，对不起，各位。"
...
translate chinese v2s39_stop_lindsey_b79c74ac:
    ...
    li "*醉醺醺* 没有会长的奖学金，她就得把所有的硅胶都卖给外科医生……"
...
translate chinese v2s39_stop_lindsey_5058906d:
    ...
    u "(没有酒精会很困难。我可以试着欺骗琳赛，但是……如果她在清醒的时候说错话，我会非常惊讶的。)"
...
translate chinese v2s39_stop_lindsey_fad85dba:
    ...
    li "我不讨厌她，[name]。克洛伊是小鸡会成员，永远是女生会的姐妹。"
...
translate chinese v2s39_stop_lindsey_c21f0f74:
    ...
    au "不客气……既然你赢得了我们的支持，我们能谈点别的吗？还是去跳舞？"
