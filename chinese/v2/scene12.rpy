...
translate chinese v2s12_c7e84e64:
    ...
    li "现在什么视频都有！这个是关于这款日记本的，是不是很疯狂？"
...
translate chinese v2s12_f8051460:
    ...
    li "*嘲笑* 她想坑我，[name]，这样她就可以公然让我难堪……你能相信吗？"
...
translate chinese v2s12_423d9fad:
    ...
    li "*叹气* 我很高兴我提前得到了这个信息，谁知道我刚刚避免了什么样的麻烦。"
...
translate chinese v2s12_3ed46461:
    ...
    li "但现在我知道了，在这一切结束之前不能喝酒，也不能碰克洛伊……"
...
translate chinese v2s12_26589a2b:
    ...
    li "我得承认，我需要钱才能赢。所以我们才拿了她的日记。但是克洛伊有钱，有资源……"
...
translate chinese v2s12_568c7465:
    ...
    li "我猜到了这一点，他不会让她去任何地方除非告诉他，她要去哪里，和谁一起。"
...
translate chinese v2s12_87e2f7c0:
    ...
    li "过了一段时间，她意识到如果她不想整天被吼和不被信任，她就必须结束和他的关系。"
...
translate chinese v2s12_1090a9c3:
    ...
    li "但客观的说，这只是故事的一面。我猜你得偷格雷森的日记才能知道全部的情况？"
...
translate chinese v2s12_ab3c4816:
    ...
    li "我只想知道你对她是不是认真的，因为如果你是认真的，那我们就应该……"
...
translate chinese v2s12_a28dce65:
    ...
    li "所以，我是这么想的……基本上，我们这次的重点是争取更多的盟友。"
...
translate chinese v2s12_b1b78f6e:
    ...
    li "我们可以信任的盟友，在选举期间支持我们，在未来，当我成为小鸡会会长的时候也支持我们。"
...
translate chinese v2s12_a3551496:
    ...
    li "我有个很棒的主意，组织一个VIP之夜。但是我已经问过了，实际上我负担不起费用。"
...
translate chinese v2s12_93421352:
    ...
    li "我们只是没有得到一个足够好的汽车售价，但希望我们未来可以把这笔钱在到刀刃上。"
...
translate chinese v2s12_05fb6a4d:
    ...
    li "所以基本上，这就是你认为应该邀请的人，以及获得他们支持的最好方式。"
...
translate chinese v2s12_fd3fa15c:
    ...
    u "他们都是好主意，我想我们可以去俱乐部，或者是一个游戏之夜，最后都会有一段美好的时光……"
...
translate chinese v2s12_12d63199:
    ...
    u "但在坐着你的豪华轿车，带她们出去狂欢之后，他们就不可能支持克洛伊了。"
...
translate chinese v2s12_dd543e97:
    ...
    u "克洛伊刚刚宣布狼人是她的正式兄弟学生会，但是塞巴斯蒂安在那里肯定会让他们起疑心。"
...
translate chinese v2s12_f3e65369:
    ...
    u "(让猿人们支持克洛伊，现在试图让塞巴斯蒂安影响狼人，我要让所有人都参与进来！)"
