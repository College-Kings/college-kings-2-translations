...
translate chinese v2s25_fa5bd036:
    ...
    admin "您好，这里是芒果酒吧的贵宾预订处，有什么可以为您效劳的吗？"
...
translate chinese v2s25_a9997c21:
    ...
    admin "好极了。我为你们预定好了贵宾区，我们会派最好的豪华轿车让你们都能体面地到达。"
...
translate chinese v2s25_c2a3af91:
    ...
    admin "好吧……如果你们未成年，我们就不能给你们提供酒水了。"
...
translate chinese v2s25_2ade84bf:
    ...
    u "我们的大学正在举行会长选举，如果一切顺利，这将有助于赢得一些有影响力的人的选票。"
...
translate chinese v2s25_8381da7b:
    ...
    admin "听起来不错，亲爱的。但如果你未成年，我们不能给你们酒，就这么简单。"
...
translate chinese v2s25_850b643f:
    ...
    admin "我相信她会的，但是法定饮酒年龄，对不起，我无能为力。"
...
translate chinese v2s25_0864c408:
    ...
    admin "我妈妈去世后，我尝试了一些新的兴趣爱好，这对我很有帮助。听起来你的朋友也在做同样的事。"
...
translate chinese v2s25_bcedf10b:
    ...
    admin "那我就不打勾了，这样你们就能喝点儿酒，没人会检查你们的身份证，好吗？"
...
translate chinese v2s25_98e70f5f:
    ...
    u "从法律上讲，我们可以喝几杯，然后再看看晚上怎么样。听起来怎么样？"
...
translate chinese v2s25_c89f406d:
    ...
    admin "听起来是违法的，先生，而且网络也不是可靠的信息来源，对不起。"
...
translate chinese v2s25_4a1da67c:
    ...
    admin "所以，整个聚会的费用是800美元。你们一到就得付钱。"
...
translate chinese v2s25_c2c0b547:
    ...
    admin "所以，全套VIP派对套餐，不含酒精，一共700美元。你们一到就得付钱。"
...
translate chinese v2s25_013f2a9f:
    ...
    admin "太好了！我要说的就是，感谢您选择芒果酒吧VIP派对套餐！祝您今天愉快！"
...
translate chinese v2s25_b3f2e1ec:
    ...
    admin "这是 VIP 派对套餐。专为有钱享受VIP生活的人设计的。"
...
translate chinese v2s25_149260ae:
    ...
    admin "我很高兴我们最后到了这里，感谢你们成为我们的顾客。"
...
translate chinese v2s25_9af61382:
    ...
    admin "是的。我们不能给你们提供任何酒精饮料，但你们仍然可以得到一系列的鸡尾酒，苏打水和果汁都包括在内。"
...
translate chinese v2s25_1e420485:
    ...
    admin "这是贵宾派对套餐，如果便宜的话，就不是给贵宾准备的了。"
...
translate chinese v2s25_6c208ea3:
    ...
    admin "你们仍然可以选择一系列的鸡尾酒，苏打水和果汁，都包括在价格内。"
...
translate chinese v2s25_3d2576d1:
    ...
    admin "不，听起来不傻。我妈妈最近也去世了。祝福你的朋友。"
...
translate chinese v2s25_e01feec0:
    ...
    admin "听起来你的朋友通过做一些有意义的事情应对得很好，这对我很有帮助。"
...
translate chinese v2s25_02be77ed:
    ...
    admin "哈，对不起，订单已经生成了。我相信不管怎样你们都会玩得很开心的。"
