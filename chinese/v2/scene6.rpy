...
translate copyme v2s6_9490c508:
    ...
    cl "有人偷了我的竞选经费。 *哭诉* 那可是他妈的五百美元啊，[name]。"
...
translate copyme v2s6_a3772507:
    ...
    cl "有人偷了我的竞选经费。 *哭诉* 那可是他妈的九百美元啊，[name]。"
...
translate copyme v2s6_f1828e9d:
    ...
    cl "他们出现在我房间里！如果他们在我睡觉的时候出现呢？我现在可能已经死了，我-"
...
translate copyme v2s6_2ea0755c:
    ...
    cl "虽然不是世界末日，但它们还是出现在我房间里，有人溜进我房间里……"
...
translate copyme v2s6_5614616e:
    ...
    cl "他们拿走了一切，[name]。我所有的竞选经费……都没了！ *哭诉*"
...
translate copyme v2s6_7d3394e7:
    ...
    cl "我把它们都放在房间里，意思是……有人进去拿走了，全都没了！"
...
translate copyme v2s6_b33ffa42:
    ...
    cl "但它不见了，我到处都找不到。我所有最私密的想法都写在里面了。"
...
translate copyme v2s6_705daadd:
    ...
    cl "我觉得自己内心完全公之于众了，因为我知道可能有别人正在读这些内容。 *抽泣*"
...
translate copyme v2s6_7bcac9a7:
    ...
    cl "是的，我也是！里面写了很多关于我们俩的事情。 *抽泣* 我很抱歉。"
...
translate copyme v2s6_237a4899:
    ...
    u "只要你继续朝着你的目标前进，那就是成为小鸡会的会长……那就是你的目标，不是吗？"
...
translate copyme v2s6_ebdb97aa:
    ...
    cl "我该怎么办？我真的被抢了！我要进行全面调查，还是这会给我带来更大的压力？"
...
translate copyme v2s6_7e5daeee:
    ...
    cl "如果我输了竞选，我就会失去奖学金，这会导致我退学，因为我付不起最后一个学期的学费。"
...
translate copyme v2s6_aff97532:
    ...
    u "克洛伊？你为什么这么在意两个随机的人支持你？不是只有小鸡成员才有投票权吗？"
...
translate copyme v2s6_ce20289e:
    ...
    cl "没错，但是每个女生都有女生会以外的朋友。她们中的每一个人都会受到公众舆论的影响。"
...
translate copyme v2s6_004e56b5:
    ...
    cl "这就是为什么学校里的每个人都支持我而不是林赛的原因。不仅仅是因为小鸡会。"
