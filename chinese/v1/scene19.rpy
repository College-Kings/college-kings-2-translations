...
translate chinese v1s19_76622052:
    ...
    u "哈……没有\"嗨？\"没有\"课上得怎么样？\"巴拉？巴拉？巴拉？什么都没有？"
...
translate chinese v1s19_4be3ae55:
    ...
    cl "对不起，[name]，我只是真的很专注和焦虑，开始考虑林赛竞选已经发生一整天了。"
...
translate chinese v1s19_3ca0e6d1:
    ...
    cl "我竞选的第一阶段就是重建旧的忠诚。我第一次当选的时候，人们喜欢我，我需要提醒她们为什么。"
...
translate chinese v1s19_continue_1bf4d4fe:
    ...
    cl "如果我们成功了，小鸡会和猿人的联盟会给小鸡会带来一个有趣的未来。"
...
translate chinese v1s19_continue_ad57e28d:
    ...
    cl "我知道克里斯信任我，所以我很确定狼人已经站在我们这边了。不过我们会知道的……"
...
translate chinese v1s19_continue_42a399c2:
    ...
    cl "这些都是你的选择，记住这一点。所以，一定要在那里帮助我，当时机成熟的时候，好吗？"
...
translate chinese v1s19_continue_10c0579b:
    ...
    cl "额，我告诉她我们会处理的。一切都很好，如果你不按时交表，学校肯定会大惊小怪的。"
