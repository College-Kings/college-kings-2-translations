...
translate copyme strings:
    ...
    new "THIS MODE PROHIBITS you from saving during important choices, meaning all choices are final. this can't be disabled without starting a new game."

    # game/screens/real_life_mode_screen.rpy:14
    old "ENABLE"
    new "ENABLE"

    # game/screens/real_life_mode_screen.rpy:22
    old "DISABLE"
    new "DISABLE"
